...
# 1. Label Pocket (Rounded rectangle, uniform depth)
# Center Y = 32.0, Width = 14.0, Height = 18.0, Radius = 2.8, Depth = 0.55
RECT_CY = 32.0
RECT_W = 14.0
RECT_H = 18.0
RECT_R = 2.8
...
xc = RECT_W/2.0 - RECT_R # 4.2
yc = RECT_H/2.0 - RECT_R # 6.2
...
# Inner floor edges fillet for rounded transition
...
if FreeCADGui.ActiveDocument:
    ...
    view.fitAll()
    view.saveImage(f'{art_dir}/back_closed_soft.png', 1200, 1600, 'Current')
    
    # Close-up of the upper back section with rectangle and dish
    view.setCameraOrientation(FreeCAD.Rotation(FreeCAD.Vector(0, 1, 0), 180))
    view.fitAll()
    view.zoomIn()
    view.saveImage(f'{art_dir}/back_upper_soft_closeup.png', 1200, 1200, 'Current')
    
    # Iso view
    view.setCameraOrientation(FreeCAD.Rotation(0.24, -0.74, 0.60, 0.18))
    view.fitAll()
    view.saveImage(f'{art_dir}/iso_soft.png', 1200, 1600, 'Current')

doc.saveAs('/tmp/freecad/LG_AC_Remote.FCStd')
print('SOFT POCKET TEST COMPLETE')
'''
